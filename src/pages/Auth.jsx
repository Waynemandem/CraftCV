...
export default function Auth() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    // Auth logic goes here later (Supabase)
      ...
      <div className="hidden md:flex flex-col justify-between bg-[#3D2B6B] p-12">
        ...
        <div>
          ...
          <p className="text-[#C4B8E8] text-sm leading-relaxed max-w-xs">
            AI-powered. ATS-friendly. Built for professionals
        ...
        <p className="text-[#9B8DC0] text-xs">
          Built by <a href="https://saturnlab.dev"
            className="text-[#C4B8E8] hover:underline">Saturn Lab</a>
        </p>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="flex border border-[#E4E2EE] rounded-md p-1 bg-white mb-8">
            {['signup', 'login'].map(t => (
              <button
                ...
                onClick={() => setTab(t)}
                className={`
                  flex-1 py-2 text-sm font-medium rounded transition-all duration-150
                  ${tab === t
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <Input
              ...
              hint={tab === 'signup' ? 'Minimum 8 characters' : ''}
              required
            />

            {tab === 'login' && (
              <div className="text-right -mt-1">
                <a href="#" className="text-xs text-[#3D2B6B] hover:underline">
                  Forgot password?
                </a>
              </div>
            )}
          ...
          <button className="
            ...
            border border-[#E4E2EE] bg-white rounded-md
            py-2.5 text-sm font-medium text-[#2C2C36]
            hover:bg-[#F8F7FC] transition-colors duration-150
          ">
